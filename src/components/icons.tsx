...
export function Arrow({ s = 14 }: SvgSize) {
  return (
    <svg className="arrow" width={s} height={s} viewBox="0 0 14 14" fill="none">
      <path d="M1 7H13M13 7L8 2M13 7L8 12" stroke="currentColor" strokeWidth="1.2" />
    </svg>
  );
}

export function ArrowDiag({ s = 12 }: SvgSize) {
  return (
